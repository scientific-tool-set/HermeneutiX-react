 ...
 * @returns {{ action: string, target: PlainProposition, parent: PlainProposition, syntacticFunction: SyntacticFunction }} created action
 */
 ...
 * @returns {{ action: string, propOne: PlainProposition, propTwo: PlainProposition }} created action
 */
 ...
 * @returns {{ action: string, proposition: PlainProposition }} created action
 */
export const removeOneIndentation = proposition => createAction(REMOVE_INDENTATION, { proposition });

/**
 * Action Creator: Split the selected proposition after the designated clause item and remove all relations that will become invalid by this change.
 * @param {PlainProposition} proposition - proposition two split into two independent ones
 * @param {PlainClauseItem} lastItemInFirstPart - last clause item after which to split the proposition
 * @returns {{ action: string, proposition: PlainProposition, lastItemInFirstPart: PlainClauseItem }} created action
 */
 ...
 * @returns {{ action: string, partAfterArrow: PlainProposition }} created action
 */
 ...
 * @returns {{ action: string, itemToMerge: PlainClauseItem }} created action
 */
 ...
 * @returns {{ action: string, itemToSplit: PlainClauseItem, firstOriginTextPart: string }} created action
 */
 ...
 * @returns {{ action: string, associates: Array.<(PlainRelation|PlainProposition)>, template: RelationTempate }} created action
 */
 ...
 * @returns {{ action: string, relation: PlainRelation }} created action
 */
 ...
 * @returns {{ action: string, relation: PlainRelation, template: RelationTempate }} created action
 */
 ...
 */
export const removeRelation = relation => createAction(REMOVE_RELATION, { relation });
 ...
 * @returns {{ action: string, propositions: Array.<PlainProposition> }} created action
 */
